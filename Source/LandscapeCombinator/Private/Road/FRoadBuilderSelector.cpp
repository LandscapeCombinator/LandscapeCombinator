...
void FRoadBuilderSelector::AddRoads(int WorldWidthKm, int WorldHeightKm, double ZScale, double WorldOriginX, double WorldOriginY)
{
	...
	OverpassQuery = FString::Format(
		TEXT("https://overpass-api.de/api/interpreter?data=%5Bbbox%3A{0}%2C{1}%2C{2}%2C{3}%5D%3Bway%5B%22highway%22%7E%22{4}%22%5D%3B%28%2E%5F%3B%3E%3B%29%3Bout%3B%0A"),
		{
			South, West, North, East,
			DetailsString().ToLower().Replace(TEXT(" | "), TEXT("%7C")) // for example primary%7Csecondary%7Ctertiary
		}
	);
