...
public:
	...
	UPROPERTY(
		EditAnywhere, BlueprintReadWrite, Category = "Decals",
		meta = (EditCondition = "DecalCreation == EDecalCreation::MapTiler", EditConditionHides, DisplayPriority = "3")
	)
	bool Decals_MapTiler_2x = false;
...
private:
	...
	UPROPERTY()
	TObjectPtr<ALandscape> SpawnedLandscape = nullptr;

	UPROPERTY()
	TObjectPtr<ADecalActor> DecalActor = nullptr;
