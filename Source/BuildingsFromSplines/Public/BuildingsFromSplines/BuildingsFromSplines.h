...
struct FWeightedBuildingConfiguration
{
	GENERATED_BODY()
	...
	static TObjectPtr<UBuildingConfiguration> GetRandomBuildingConfiguration(TArray<FWeightedBuildingConfiguration>& BuildingConfigurations);
};
...
public:
	...
	bool bContinueDespiteErrors = false;
	...
	TArray<FWeightedBuildingConfiguration> BuildingConfigurations;
	...
	UFUNCTION(BlueprintCallable, CallInEditor, Category = "Buildings",
		meta = (DisplayName = "Generate Buildings", DisplayPriority = "101")
	)
