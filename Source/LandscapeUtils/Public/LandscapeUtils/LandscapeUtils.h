...
public:
	...
	static bool ExtendLandscape(ALandscape *LandscapeToExtend, FString Heightmap, bool bUpdateAllOverlappingComponents);
	static bool ExtendLandscape(ALandscape *LandscapeToExtend, TArray<FString> Heightmaps, bool bUpdateAllOverlappingComponents);
